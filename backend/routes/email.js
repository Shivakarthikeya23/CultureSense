...
function generateEmailHTML(profile) {
  ...
  return `
    ...
    <head>
      ...
      <title>Your CultureSense Profile</title>
      <style>
        body {
    ...
    <body>
      ...
      <div class="footer">
        <p>Generated by CultureSense</p>
        <p>Discover your cultural personality at <a href="http://localhost:3000">CultureSense.com</a></p>
      </div>
    </body>
    </html>
  `;
