...
router.post("/cross-domain-analysis", async (req, res) => {
  try {
    ...
    const result = {
      connections:
        culturalAnalysis.cross_domain_insights?.map((insight) => ({
